...
const styles = {
  ...
  subtext: { fontSize: 14, color: "#64748b", margin: "0 0 18px" },
  ...
  orDivider: { display: "flex", alignItems: "center", gap: 10, margin: "16px 0" },
  ...
  submitBtn: { width: "100%", padding: "13px", background: "var(--tk-gradient, linear-gradient(90deg,#3B82F6,#06B6D4))", color: "#fff", border: "none", borderRadius: 10, fontSize: 14, fontWeight: 700, cursor: "pointer", marginTop: 4, letterSpacing: "0.2px", transition: "opacity 0.15s" },
