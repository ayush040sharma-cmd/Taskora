...
const TRUST_ITEMS = [
  { icon: "🔒", label: "Enterprise-ready security" },
  ...
  return (
    <div className="auth-canvas">
      ...
      <div className="auth-page-inner">
        {/* ── Brand lockup — states what this is once, at the top, so
            neither the card nor the preview has to repeat it ── */}
        <div className="auth-lockup">
          <Logo iconSize={26} wordmarkSize={20} />
          <div className="auth-lockup-tagline">
            <span className="auth-split-pulse" />
            Execution Intelligence
          </div>
        </div>

        <div className="auth-stage-inner">
        {/* ── Sign-in card — the sole light surface, so it reads as the
            page's one focal point by contrast alone ── */}
        <div className="auth-login-card">
          ...
          {/* Email/password is the primary path — Google and Demo are
              secondary alternatives listed below it, not competing for
              top billing. */}
          ...
          <button style={demoLoading ? {...styles.demoLink, opacity: 0.6, cursor: "not-allowed"} : styles.demoLink} onClick={handleDemo} disabled={demoLoading}>
        ...
        {/* ── Product showcase — hidden below 1320px ── */}
        <div className="auth-stage-showcase">
          <h2 className="auth-split-headline">
            Know what will slip<br />
            <span className="accent">before it does.</span>
          </h2>

          <div className="auth-stage-mockup-wrap">
            <div className="auth-ai-float">
              <div className="auth-ai-float-head">
                <span className="auth-ai-float-dot" />
                JARVIS AI
              </div>
              <div className="auth-ai-float-risk">Sprint 14 delivery risk — 73%</div>
              <div className="auth-ai-float-rec">Reassign to Alex → saves 3 days</div>
            </div>
            <div className="auth-status-float">
              <span className="auth-status-float-dot" />
              Workload balanced
            </div>
            <div className="auth-stage-mockup">
              <DashboardMockup />
            </div>
          </div>
        </div>
        ...
        <div className="auth-trust-strip">
          <span className="auth-trust-label">Built for engineering, product &amp; delivery teams</span>
          <div className="auth-trust-items">
            {TRUST_ITEMS.map(t => (
              <span className="auth-trust-item" key={t.label}>
...
const styles = {
  ...
  heading: { fontFamily: "var(--tk-font-display, 'Syne')", fontSize: 24, fontWeight: 700, color: "#0f172a", margin: "0 0 4px", letterSpacing: "-0.5px" },
  subtext: { fontSize: 13, color: "#64748b", margin: "0 0 6px" },
  infoBox: { display: "flex", alignItems: "center", gap: 8, background: "#eff6ff", border: "1px solid #bfdbfe", color: "#1d4ed8", borderRadius: 10, padding: "8px 12px", fontSize: 13, fontWeight: 500, marginBottom: 12 },
  errorBox: { display: "flex", alignItems: "center", gap: 8, background: "#fef2f2", border: "1px solid #fecaca", color: "#dc2626", borderRadius: 10, padding: "8px 12px", fontSize: 13, fontWeight: 500, marginBottom: 12 },
  googleBtn: {
    width: "100%", padding: "9px 16px",
    background: "#fff", border: "1.5px solid #e2e8f0",
    borderRadius: 10, fontSize: 14, fontWeight: 600, color: "#374151",
    cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center",
    gap: 10, marginBottom: 4, transition: "all 0.15s",
  },
  demoLink: {
    width: "100%", padding: "5px 4px",
    background: "none", border: "none",
    fontSize: 13, fontWeight: 600, color: "#64748b",
    cursor: "pointer", marginTop: 0, textAlign: "center",
  },
  orDivider: { display: "flex", alignItems: "center", gap: 10, margin: "8px 0" },
  ...
  input: { width: "100%", padding: "10px 14px", border: "1.5px solid #e2e8f0", borderRadius: 10, fontSize: 14, color: "#0f172a", background: "#f8fafc", outline: "none", transition: "border-color 0.15s", boxSizing: "border-box", fontFamily: "inherit", colorScheme: "light" },
